def prompt(job_title, resume_text):
    ...
    3. Compare both and provide:
       ...
       - Top 5 goals to improve resume. the goals should be in this format: ["title of Goal:Description/objective.", "title of Goal:Description/objective."]. Respond only with 5 goals and not more or less.
